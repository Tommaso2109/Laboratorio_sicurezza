...
<body>
    ...
    <div class="mt-3_5">
        <div class="grid-container">
            ...
            <div class="card">
                <div class="image-box">
                    <img src="media/alpine_car.avif">
                </div>
                <div class="content">
                    <!-- <h2>Ford Mustang 1969</h2> -->
                    <p> Dopo il rientro in Formula 1, avvenuto nel 2016, il team francese aveva 
                        ambiziosi obiettivi e puntava al vertice. I risultati finora non le hanno 
                        dato ragione: il quinto posto del 2019 è arrivato senza nemmeno un podio 
                        e fra tanti e bassi. Decisamente meglio il 2020, anno in cui sono arrivati 
                        tre podi, nel 2021 arriva invece la prima vittoria conquistata da Ocon. Nel 
                        2022 l’Alpine, pur non avendo conquistato nessun podio, è stata molto costante 
                        nei piazzamenti, chiudendo al quarto posto della classifica mondiale, superando 
                        anche la rivale McLaren. La novità principale del 2023 è costituita dall’uscita 
                        di scena dell’esperto Fernando Alonso, sostituito da Pierre Gasly, che va così 
                        ad affiancare Ocon, costituendo una coppia di piloti tutta francese. 
                        
                        La nuova monoposto può essere definita di continuità, in quando va a migliorare 
                        la A523, senza però effettuare grandi stravolgimenti. Il telaio è stato ridisegnato, 
                        sono state poi introdotte delle nuove sospensioni posteriori, mentre quelle anteriori 
                        sono state ottimizzate. Inoltre, è stato integrato un rinnovato sistema di smaltimento 
                        del calore derivante dal sistema frenante.
                        
                        L’Alpine A524 punta a migliorare il sesto posto ottenuto lo scorso anno con 120 punti 
                        conquistati. La coppia di piloti francesi sarà nuovamente composta da Esteban Ocon e 
                        Pierre Gasly. </p>
                </div>
            </div>
        ...
        <div class="poster__telefono_2 mt-1">
                ...
                <img src="media/alpine_car.avif" alt="">
                <p class="description">
                    Dopo il rientro in Formula 1, avvenuto nel 2016, il team francese aveva 
                    ambiziosi obiettivi e puntava al vertice. I risultati finora non le hanno 
                    dato ragione: il quinto posto del 2019 è arrivato senza nemmeno un podio 
                    e fra tanti e bassi. Decisamente meglio il 2020, anno in cui sono arrivati 
                    tre podi, nel 2021 arriva invece la prima vittoria conquistata da Ocon. Nel 
