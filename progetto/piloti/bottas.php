...
<body>
    ...
    <div class="hero">
        <div class="hero__content ">
            <h1 class = "big-text">VALTERRI BOTTAS </h1>
        </div>
        <video autoplay muted loop id="video">
            <source src="media/bottas_video.mp4" type="video/mp4">
    ...
    <div class="mt-2 scroll">
        <main>
            ...
            <li class="item" style="background-image: url('media/carriera_stake.jpg')";>
                ...
                <p class="description">
                    Bottas ha iniziato la sua carriera in Formula 1 come pilota di riserva per 
                    il team Williams nel 2010, prima di essere promosso a pilota titolare nel 2013. 
                    <br>
                    Nel 2017, Bottas ha ottenuto la sua prima vittoria in Formula 1 al Gran Premio di 
                    Russia e ha continuato a dimostrare le sue abilità con altre vittorie e podi nel 
                    corso della stagione.
                    <br>
                    Nel 2019, Bottas ha continuato a essere una forza competitiva, ottenendo vittorie 
                    e podi durante la stagione e lottando per il titolo mondiale. Ha chiuso la stagione 
                    come vice-campione del mondo.
                    <br>
                    Nel 2020, nonostante alcune difficoltà, Bottas ha ottenuto una vittoria nella stagione 
                    e ha continuato a essere un pilota forte per il team Mercedes.
                    <br>
                    Nel 2021, Bottas ha continuato a gareggiare per la Mercedes, ma ha incontrato alcune 
                    sfide durante la stagione. Nonostante ciò, è riuscito a ottenere alcuni podi e una vittoria, 
                    dimostrando il suo valore come pilota.
                    <br>
                    Nel 2022, Bottas ha iniziato una nuova avventura con il team Alfa Romeo, lasciando la Mercedes 
                    dopo cinque stagioni di successi.
                </p>
                </div>
            </li>
            <li
                class="item"
                style="background-image: url('media/stats_bottas.webp')"
            >
                <div class="content">
                <h2 class="title" style="font-size:60px;">"Statistiche"</h2>
                <p class="description">
                    Bottas ha avuto successo insieme ad Hamilton in Mercedes negli anni di 
                    dominazione di Mercedes. Vincendo ben 10 gare, 67 podi, 20 pole position e 7.5 
                    punti per gara. In 12 stagioni di gareggio, sono delle ottime statistiche, 
                    sfortunatamente la nuova Sauber non ha dimostrato una ottima macchina, come
                    la precedente Alpha Romeo; quindi è improbabile che Bottas mantenga queste statistiche.
                </p>
                <a href=""><button>Read More</button></a>
                </div>
            </li>
            <li class="item" style="background-image: url('media/biografia_bottas.jpg');">
                <div class="content">
                <h2 class="title" style="font-size: 60px;">"Biografia"</h2>
                <p class="description">
                    Valtteri Bottas è nato il 28 agosto 1989 a Nastola, in Finlandia. Fin da 
                    giovane ha mostrato un grande interesse per le corse automobilistiche e 
                    ha iniziato a gareggiare nel karting prima di passare alle competizioni su pista.
                </p>
            </li>
    ...
    <div class="hero-telefono" style=" background-image: url('media/bottas_phone.jpg');">
        <div class="hero-telefono__content">
            <h1 class = "medium-text"> VALTERRI BOTTAS</h1>
        </div>
    </div>
