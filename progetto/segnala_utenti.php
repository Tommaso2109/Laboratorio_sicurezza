...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="style_segnala.css">
    ...
    <body>
        ...
        <div class="mt-3">
            <h2>Segnala gli utenti che hanno avuto dei comportamenti irrispettosi </h2>
            <?php
            ...
            $sql = "SELECT username FROM utenti WHERE moderatore = 0";
